...
const Stats: React.FC = () => {
  return (
    <div className="max-w-[85rem] mx-auto bg-[#333333] my-10 py-10 text-white rounded-[1rem]">
      <h2 className="text-center pb-10 text-[22px] md:text-[40px] md:px-16 px-4  leading-tight">
      ...
      <div className="flex justify-center">
        <div className="text-center mx-14">
          <img 
            ...
            alt="Ad Revenue Icon"
          />
          <h3 className="md:text-[30px] text-[#FCEB86]">3X Increase</h3>
          <p className="md:text-[18px]">in ad revenues</p>
        </div>
        <div className="text-center mx-14">
          <img
            className="mx-auto h-[5rem] w-[5rem]"
